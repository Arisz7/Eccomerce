...
const Card = ({ item }) => {
    ...
    return (
        ...
        <>
            <div class="flex lg:flex-row flex-row-reverse lg:pr-0 m-0 pr-40">
                <div class="flex-shrink-0 m-6 relative overflow-hidden bg-white/50 rounded-lg max-w-lg shadow-lg">
                    <div class="relative pt-10 px-10 flex items-center justify-center">
                        ...
                        <img class="relative h-[250px] w-[210px] lg:h-[250px] lg:w-[210px] xl:h-[150] xl:w-[100] 2xl:w-[80] 2xl:h-[90   ]" src={item.img} alt="" />
                    </div>
